...
<?php
  echo '</li>
  <li><a href="javascript:void(0)" onclick="setCookie(\'weathercity\',\'\',-365);setCookie(\'weathercity2\',\'\',-365);setCookie(\'weatherfrom\',\'\',-365);document.getElementById(\'reloadcity\').contentWindow.location.reload(true);alert(\'清除成功。请重启浏览器并刷新首页观察\');return false;" style="color:blue;">清除Cookie</a></li>
</ul>
</body>
</html>
';
